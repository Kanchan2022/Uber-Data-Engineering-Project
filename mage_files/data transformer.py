#This Mage data transformer receives the raw DataFrame from the loader, applies cleaning and transformation steps such as removing duplicates, renaming columns, filtering invalid records, and creating derived fields, and outputs analytics-ready fact and dimension tables.
...
def transform(df, *args, **kwargs):
    ...
    drop_location_dim = df[['DOLocationID']].reset_index(drop=True)
    drop_location_dim['drop_location_id'] = drop_location_dim.index
    drop_location_dim = drop_location_dim[['drop_location_id','DOLocationID']] 
